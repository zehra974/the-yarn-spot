...
const API_URL = "https://the-yarn-spot.vercel.app/api/orders";
...
export default function Checkout() {
  ...
  const [placedPaidAmount, setPlacedPaidAmount] = useState(0);
  const [placedRemainingAmount, setPlacedRemainingAmount] = useState(0);
  const [placedPaymentType, setPlacedPaymentType] = useState("Advance");
  ...
  const selectedPaymentAmount =
    paymentType === "Full" ? orderTotal : advanceAmount;

  const remainingAmount = Math.max(
    orderTotal - selectedPaymentAmount,
    0
  );
  ...
  useEffect(() => {
    const elements = document.querySelectorAll(".checkout-animate");
  ...
  const handlePlaceOrder = async (e) => {
    ...
    try {
      ...
      setPlacedOrderId(savedOrder?._id || "");

      setPlacedOrderTotal(
        Number(savedOrder?.totalAmount ?? orderTotal)
      );

      setPlacedPaidAmount(
        Number(
          savedOrder?.paidAmount ?? selectedPaymentAmount
        )
      );

      setPlacedRemainingAmount(
        Number(
          savedOrder?.remainingAmount ?? remainingAmount
        )
      );
          ...
          <div className="checkout-animate opacity-0">
            <div className="sticky top-28 rounded-[30px] bg-black p-7 text-white shadow-2xl md:p-8">
                ...
                {cartItems.length === 0 ? (
                  ...
                  cartItems.map((item, index) => (
                    <div
                      ...
                      style={{
                        animation: `checkoutItem 0.45s ease ${
                          index * 0.08
                        }s both`,
                      }}
                    >
                ...
                <div className="mt-4 rounded-2xl border border-[#D4A017]/30 bg-[#D4A017]/10 p-4">
                  ...
                  <p className="mt-2 text-sm text-gray-300">
                    ...
                    <span className="ml-1 font-bold text-white">
                      Rs. {selectedPaymentAmount.toLocaleString()}
                    </span>
                  </p>
                  ...
                  <p className="mt-3 text-xs leading-5 text-gray-400">
                    After payment, The Yarn Spot will verify your payment
              ...
              <p className="mt-5 text-center text-xs leading-5 text-gray-500">
                Payment will be verified by The Yarn Spot before your order
                is confirmed.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative mb-5 space-y-3 rounded-2xl bg-white px-5 py-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-[#8B6914]">
                  Rs. {placedPaidAmount.toLocaleString()}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between border-t border-gray-100 pt-3">
                ...
                <span className="font-semibold">
                  Rs. {placedRemainingAmount.toLocaleString()}
                </span>
              </div>
            </div>
            ...
            <div className="relative mb-6 rounded-2xl bg-black p-5 text-left text-white">
              ...
              <p className="mt-4 text-sm leading-6 text-gray-400">
                After sending the payment, please keep your payment
                confirmation. The Yarn Spot will verify it and confirm
